...
main(int argc, char *argv[])
{
 ...
 11e:	c7 44 24 04 60 0b 00 	movl   $0xb60,0x4(%esp)
 125:	00 
 126:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
 12d:	e8 60 06 00 00       	call   792 <printf>
    exit();
 ...
 1b0:	c7 44 24 04 80 0b 00 	movl   $0xb80,0x4(%esp)
 1b7:	00 
 1b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 1bf:	e8 ce 05 00 00       	call   792 <printf>
      exit();
...
putc(int fd, char c)
{
 ...
 699:	88 45 e4             	mov    %al,-0x1c(%ebp)
  int start = uptime();
 69c:	e8 bf ff ff ff       	call   660 <uptime>
 ...
 6b9:	e8 2a ff ff ff       	call   5e8 <write>
  int end = uptime();
 6be:	e8 9d ff ff ff       	call   660 <uptime>
 6c3:	89 45 f0             	mov    %eax,-0x10(%ebp)
  IOTime(end - start);
 6c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
 6c9:	8b 55 f0             	mov    -0x10(%ebp),%edx
 6cc:	29 c2                	sub    %eax,%edx
 6ce:	89 d0                	mov    %edx,%eax
 6d0:	89 04 24             	mov    %eax,(%esp)
 6d3:	e8 a0 ff ff ff       	call   678 <IOTime>
}
 6d8:	c9                   	leave  
 6d9:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6ed:	74 17                	je     706 <printint+0x2c>
 6ef:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 6f3:	79 11                	jns    706 <printint+0x2c>
    neg = 1;
 ...
 704:	eb 06                	jmp    70c <printint+0x32>
  } else {
    x = xx;
 ...
 70c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 713:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 716:	8d 41 01             	lea    0x1(%ecx),%eax
 ...
 72b:	0f b6 80 64 0e 00 00 	movzbl 0xe64(%eax),%eax
 732:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 736:	8b 75 10             	mov    0x10(%ebp),%esi
 ...
 74a:	75 c7                	jne    713 <printint+0x39>
  if(neg)
 74c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 750:	74 10                	je     762 <printint+0x88>
    buf[i++] = '-';
 ...
 75b:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
  ...
  while(--i >= 0)
 760:	eb 1f                	jmp    781 <printint+0xa7>
 762:	eb 1d                	jmp    781 <printint+0xa7>
    putc(fd, buf[i]);
 ...
 77c:	e8 0f ff ff ff       	call   690 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
 ...
 789:	79 d9                	jns    764 <printint+0x8a>
    putc(fd, buf[i]);
}
 78b:	83 c4 30             	add    $0x30,%esp
 78e:	5b                   	pop    %ebx
 78f:	5e                   	pop    %esi
 790:	5d                   	pop    %ebp
 791:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 7af:	e9 7c 01 00 00       	jmp    930 <printf+0x19e>
    c = fmt[i] & 0xff;
 ...
 7dd:	e9 4a 01 00 00       	jmp    92c <printf+0x19a>
      } else {
        putc(fd, c);
 ...
 888:	75 09                	jne    893 <printf+0x101>
          s = "(null)";
 88a:	c7 45 f4 96 0b 00 00 	movl   $0xb96,-0xc(%ebp)
        while(*s != 0){
 891:	eb 1e                	jmp    8b1 <printf+0x11f>
 893:	eb 1c                	jmp    8b1 <printf+0x11f>
          putc(fd, *s);
 ...
 8a8:	e8 e3 fd ff ff       	call   690 <putc>
          s++;
 8ad:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 8b9:	75 da                	jne    895 <printf+0x103>
 8bb:	eb 68                	jmp    925 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 8bd:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 8c1:	75 1d                	jne    8e0 <printf+0x14e>
        putc(fd, *ap);
 ...
 8d5:	e8 b6 fd ff ff       	call   690 <putc>
        ap++;
 8da:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 8de:	eb 45                	jmp    925 <printf+0x193>
      } else if(c == '%'){
 8e0:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 8e4:	75 17                	jne    8fd <printf+0x16b>
        putc(fd, c);
 ...
 8fb:	eb 28                	jmp    925 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 8fd:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 904:	00 
 905:	8b 45 08             	mov    0x8(%ebp),%eax
 908:	89 04 24             	mov    %eax,(%esp)
 90b:	e8 80 fd ff ff       	call   690 <putc>
        putc(fd, c);
 ...
 920:	e8 6b fd ff ff       	call   690 <putc>
      }
      state = 0;
 ...
 93d:	0f 85 71 fe ff ff    	jne    7b4 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 a1f:	a3 88 0e 00 00       	mov    %eax,0xe88
}
 a24:	c9                   	leave  
 a25:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a29:	83 ec 28             	sub    $0x28,%esp
  ...
  if(nu < 4096)
 a2c:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 a33:	77 07                	ja     a3c <morecore+0x16>
    nu = 4096;
 a35:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 a3c:	8b 45 08             	mov    0x8(%ebp),%eax
 a3f:	c1 e0 03             	shl    $0x3,%eax
 a42:	89 04 24             	mov    %eax,(%esp)
 a45:	e8 06 fc ff ff       	call   650 <sbrk>
 a4a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 a4d:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 a51:	75 07                	jne    a5a <morecore+0x34>
    return 0;
 a53:	b8 00 00 00 00       	mov    $0x0,%eax
 a58:	eb 22                	jmp    a7c <morecore+0x56>
  hp = (Header*)p;
 ...
 a72:	e8 ce fe ff ff       	call   945 <free>
  return freep;
 a77:	a1 88 0e 00 00       	mov    0xe88,%eax
}
 a7c:	c9                   	leave  
 a7d:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a9f:	75 23                	jne    ac4 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 aa1:	c7 45 f0 80 0e 00 00 	movl   $0xe80,-0x10(%ebp)
 aa8:	8b 45 f0             	mov    -0x10(%ebp),%eax
 aab:	a3 88 0e 00 00       	mov    %eax,0xe88
 ab0:	a1 88 0e 00 00       	mov    0xe88,%eax
 ab5:	a3 80 0e 00 00       	mov    %eax,0xe80
    base.s.size = 0;
 aba:	c7 05 84 0e 00 00 00 	movl   $0x0,0xe84
 ac1:	00 00 00 
  }
 ...
 b05:	c1 e0 03             	shl    $0x3,%eax
 b08:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
 b0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b0e:	8b 55 ec             	mov    -0x14(%ebp),%edx
 b11:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 b14:	8b 45 f0             	mov    -0x10(%ebp),%eax
 b17:	a3 88 0e 00 00       	mov    %eax,0xe88
      return (void*)(p + 1);
 b1c:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b1f:	83 c0 08             	add    $0x8,%eax
 b22:	eb 38                	jmp    b5c <malloc+0xde>
    }
    if(p == freep)
 b24:	a1 88 0e 00 00       	mov    0xe88,%eax
 b29:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 b2c:	75 1b                	jne    b49 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
 b2e:	8b 45 ec             	mov    -0x14(%ebp),%eax
 b31:	89 04 24             	mov    %eax,(%esp)
 b34:	e8 ed fe ff ff       	call   a26 <morecore>
 b39:	89 45 f4             	mov    %eax,-0xc(%ebp)
 b3c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b40:	75 07                	jne    b49 <malloc+0xcb>
        return 0;
 b42:	b8 00 00 00 00       	mov    $0x0,%eax
 b47:	eb 13                	jmp    b5c <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 b57:	e9 70 ff ff ff       	jmp    acc <malloc+0x4e>
}
 b5c:	c9                   	leave  
 b5d:	c3                   	ret    
